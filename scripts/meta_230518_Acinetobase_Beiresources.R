...
# THIS SCRIPT CREATES THE METADATA TABLE FOR ASSEMBLIES THAT WERE STILL MISSING
...
jobname <- "230518_Acinetobase_Beiresources"
...
meta <- meta[which(meta$assembly %in% missing == TRUE),]
